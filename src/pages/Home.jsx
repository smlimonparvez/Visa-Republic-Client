  ...
  return (
    <div className="my-16">
      <div className="w-5/6 mx-auto mt-16">
        <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
          <SwiperSlide>
            ...
            >
              <div className="text-center space-y-4 ">
                <h1 className="text-3xl md:text-6xl text-base-300 dark:text-white font-bold animate__animated animate__bounce animate__delay-2s">
                  Immigration And Visa <br className="hidden md:block" />{" "}
                  Consultation For {""}
                  <span className="text-red font-bold">
                    {/* Style will be inherited from the parent element */}
                    <Typewriter
                      words={["Students", "Tourists", "Businessmen", "Workers"]}
                      loop={5}
                      cursor
                      cursorStyle="_"
                      typeSpeed={70}
          ...
          <SwiperSlide>
            ...
            >
              <div className="text-center space-y-4 ">
                <h1 className="text-3xl md:text-6xl text-gray-500 font-bold">
                  We Are the Most Trusted <br className="hidden md:block" />{" "}
                  Visa Consultancy Agency
                </h1>
                <p className="md:text-base font-semibold text-gray-200">
                  Applying for a visa and getting the approval is tougher than
          ...
          <SwiperSlide>
            ...
            >
              <div className="text-center space-y-4 ">
                ...
                <p className="md:text-base font-semibold text-gray-300">
                  Applying for a visa and getting the approval is tougher than
                  it looks. <br className="hidden md:block" /> Illegal migration
                  or illegal documents are increasing day by day.
                </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10 w-5/6 mx-auto">
        {limitedVisa.map((visa) => (
          <Slide direction="up" cascade triggerOnce>
            <div
              key={visa._id}
              className="p-5 space-y-2 border border-gray-300 bg-gray-100 dark:bg-white dark:text-black rounded-lg shadow-md"
            >
              <img
              ...
              <button
                ...
                className="btn rounded-lg mt-5 text-lg bg-lime-300 hover:bg-lime-400 dark:border-none dark:text-black"
              >
                See Details
              </button>
            </div>
      ...
      <div className="flex items-center justify-center mt-10">
        <Link
          to="/all-visas"
          className="btn text-lg bg-lime-300 hover:bg-lime-400 dark:text-black"
        >
          See All The Visa
        </Link>
      </div>
      ...
      <div className="w-5/6 mx-auto mt-16 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 dark:text-gray-800">
          <Slide>
          ...
          <Slide>
            <div className="p-5 space-y-2 border border-gray-300 bg-gray-100 rounded-lg shadow-md">
              ...
              <p>
                Our clients' satisfaction is our top priority. We strive to
                exceed expectations at every step of the process.
              </p>
            </div>
          </Slide>
        </div>
